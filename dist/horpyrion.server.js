...
var _ContextAction = __webpack_require__(19);
...
var _Context2 = __webpack_require__(0);
...
var SchemaContext = function (_Context) {
    ...
    _createClass(SchemaContext, [{
        ...
        value: function updateRecord(recordId, data) {
            ...
            return this.resolveContextAction().then(function () {
                return _this5.updateFactory("Record")(recordId, { data: data });
            }).then(function () {
                return true;
            });
        }
        ...
        value: function removeRecord(recordId) {
            ...
            return this.resolveContextAction().then(function () {
                return _this6.removeFactory("Record")(recordId);
            }).then(function () {
                return true;
            });
        }
    ...
    _createClass(RecordContext, [{
        ...
        value: function updateRecord(data) {
            ...
            return this.resolveContextAction().then(function (_ref) {
                ...
                return _this2.updateFactory("Record")(record.id, { data: data });
            }).then(function () {
                return true;
            });
        }
...
var _UserRecordContext = __webpack_require__(17);
...
var UserSchemaContext = function (_Context) {
    ...
    _createClass(UserSchemaContext, [{
        ...
        value: function createRecord(name) {
            ...
            return this.resolveContextAction().then(function () {
                return _this2.createFactory("User")({ name: name });
            }).then(function (user) {
                return user.toJSON();
            });
        }
        ...
        value: function updateRecord(recordId, data) {
            ...
            return this.resolveContextAction().then(function () {
                return _this3.updateFactory("User")(recordId, data);
            }).then(function () {
                return true;
            });
        }
...
var _getUserRecordContextFactory = __webpack_require__(18);
    ...
    _createClass(UserRecordContext, [{
        ...
        value: function updateRecord(data) {
            ...
            return this.resolveContextAction().then(function (_ref) {
                ...
                return _this2.updateFactory("User")(userRecord.id, data);
            }).then(function () {
                return true;
            });
        }
        ...
        value: function removeRecord() {
            ...
            return this.resolveContextAction().then(function (_ref2) {
                ...
                return _this3.removeFactory("User")(userRecord.id);
            }).then(function () {
                return true;
            });
        }
...
var _throwIfNoSync = __webpack_require__(20);
